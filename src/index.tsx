...
export class Modal {
  ...
  /**
   * Show a modal. Can be called from anywhere. Modal settings reset onClose
   ...
   * @param {boolean} options.closeOnConfirm=true Set whether the modal should close after the confirm button is clicked. If false, you will need to dismiss it yourself using `Modal.dismissModal()`
